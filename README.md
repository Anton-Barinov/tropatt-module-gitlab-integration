...
2. Выберите один из вариантов:
   - **Установка по URL:** `https://github.com/Anton-Barinov/tropatt-module-gitlab-integration/releases/download/v1.0.0/crm.gitlab-integration-1.0.0.zip`
...
2. 选择以下方式之一：
   - **从 URL 安装：** `https://github.com/Anton-Barinov/tropatt-module-gitlab-integration/releases/download/v1.0.0/crm.gitlab-integration-1.0.0.zip`
